...
Zero-dependency, HTTP/1 safe, simple, <a href="https://github.com/enisdenjo/graphql-sse/blob/master/PROTOCOL.md">GraphQL over Server-Sent Events spec</a> server and client.
